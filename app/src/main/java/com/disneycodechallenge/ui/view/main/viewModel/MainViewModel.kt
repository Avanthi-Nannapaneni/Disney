...
import com.disneycodechallenge.ui.utils.DummyUtils
...
class MainViewModel(application: Application) : AndroidViewModel(application),
    ...
    fun initializeWithDummyArray() {
        _arrayReservedGuests = DummyUtils.getReservedGuests()
        _arrayNeedReservationGuests = DummyUtils.getNeededReservationGuests()
